...
from ...models.api_v2_plant_production_history_energy_retrieve_period import (
    ApiV2PlantProductionHistoryEnergyRetrievePeriod,
)
from ...models.api_v2_plant_production_history_energy_retrieve_response_format import (
...
def _get_kwargs(
    ...
    *,
    ...
    format_: Union[
        Unset, None, ApiV2PlantProductionHistoryEnergyRetrieveResponseFormat
    ] = ApiV2PlantProductionHistoryEnergyRetrieveResponseFormat.JSON,
    period: Union[
        Unset, None, ApiV2PlantProductionHistoryEnergyRetrievePeriod
    ] = ApiV2PlantProductionHistoryEnergyRetrievePeriod.VALUE_0,
    start: Union[Unset, None, datetime.datetime] = UNSET,
) -> Dict[str, Any]:
    url = "{}/api/v2/plant/{uuid}/production/history/energy/".format(client.base_url, uuid=uuid)
...
def sync_detailed(
    ...
    *,
    ...
    """Fetch produced energy history

    Args:
        uuid (str):
        cumulative (Union[Unset, None, bool]):
        end (Union[Unset, None, datetime.datetime]):
        format_ (Union[Unset, None, ApiV2PlantProductionHistoryEnergyRetrieveResponseFormat]):
            Default: ApiV2PlantProductionHistoryEnergyRetrieveResponseFormat.JSON.
        period (Union[Unset, None, ApiV2PlantProductionHistoryEnergyRetrievePeriod]):  Default:
            ApiV2PlantProductionHistoryEnergyRetrievePeriod.VALUE_0.

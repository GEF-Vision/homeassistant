...
from ...models.api_v2_plant_grid_interface_history_power_retrieve_period import (
    ApiV2PlantGridInterfaceHistoryPowerRetrievePeriod,
)
from ...models.api_v2_plant_grid_interface_history_power_retrieve_response_format import (
...
def _get_kwargs(
    ...
    *,
    ...
    format_: Union[
        Unset, None, ApiV2PlantGridInterfaceHistoryPowerRetrieveResponseFormat
    ] = ApiV2PlantGridInterfaceHistoryPowerRetrieveResponseFormat.JSON,
    period: Union[
        Unset, None, ApiV2PlantGridInterfaceHistoryPowerRetrievePeriod
    ] = ApiV2PlantGridInterfaceHistoryPowerRetrievePeriod.VALUE_1,
    start: Union[Unset, None, datetime.datetime] = UNSET,
) -> Dict[str, Any]:
    url = "{}/api/v2/plant/{uuid}/grid_interface/history/power/".format(client.base_url, uuid=uuid)
...
def sync_detailed(
    ...
    *,
    ...
    """Fetch grid interface power history

    Args:
        uuid (str):
        end (Union[Unset, None, datetime.datetime]):
        format_ (Union[Unset, None, ApiV2PlantGridInterfaceHistoryPowerRetrieveResponseFormat]):
            Default: ApiV2PlantGridInterfaceHistoryPowerRetrieveResponseFormat.JSON.
        period (Union[Unset, None, ApiV2PlantGridInterfaceHistoryPowerRetrievePeriod]):  Default:
            ApiV2PlantGridInterfaceHistoryPowerRetrievePeriod.VALUE_1.

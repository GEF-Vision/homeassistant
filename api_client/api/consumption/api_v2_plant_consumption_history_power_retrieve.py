...
from ...models.api_v2_plant_consumption_history_power_retrieve_period import (
    ApiV2PlantConsumptionHistoryPowerRetrievePeriod,
)
from ...models.api_v2_plant_consumption_history_power_retrieve_response_format import (
...
def _get_kwargs(
    ...
    *,
    ...
    format_: Union[
        Unset, None, ApiV2PlantConsumptionHistoryPowerRetrieveResponseFormat
    ] = ApiV2PlantConsumptionHistoryPowerRetrieveResponseFormat.JSON,
    period: Union[
        Unset, None, ApiV2PlantConsumptionHistoryPowerRetrievePeriod
    ] = ApiV2PlantConsumptionHistoryPowerRetrievePeriod.VALUE_1,
    start: Union[Unset, None, datetime.datetime] = UNSET,
) -> Dict[str, Any]:
    url = "{}/api/v2/plant/{uuid}/consumption/history/power/".format(client.base_url, uuid=uuid)
...
def sync_detailed(
    ...
    *,
    ...
    """Fetch consumed power history

    Args:
        uuid (str):
        end (Union[Unset, None, datetime.datetime]):
        format_ (Union[Unset, None, ApiV2PlantConsumptionHistoryPowerRetrieveResponseFormat]):
            Default: ApiV2PlantConsumptionHistoryPowerRetrieveResponseFormat.JSON.
        period (Union[Unset, None, ApiV2PlantConsumptionHistoryPowerRetrievePeriod]):  Default:
            ApiV2PlantConsumptionHistoryPowerRetrievePeriod.VALUE_1.

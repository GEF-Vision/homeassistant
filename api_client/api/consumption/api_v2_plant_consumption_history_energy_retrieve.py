...
from ...models.api_v2_plant_consumption_history_energy_retrieve_period import (
    ApiV2PlantConsumptionHistoryEnergyRetrievePeriod,
)
from ...models.api_v2_plant_consumption_history_energy_retrieve_response_format import (
...
def _get_kwargs(
    ...
    *,
    ...
    format_: Union[
        Unset, None, ApiV2PlantConsumptionHistoryEnergyRetrieveResponseFormat
    ] = ApiV2PlantConsumptionHistoryEnergyRetrieveResponseFormat.JSON,
    period: Union[
        Unset, None, ApiV2PlantConsumptionHistoryEnergyRetrievePeriod
    ] = ApiV2PlantConsumptionHistoryEnergyRetrievePeriod.VALUE_0,
    start: Union[Unset, None, datetime.datetime] = UNSET,
) -> Dict[str, Any]:
    url = "{}/api/v2/plant/{uuid}/consumption/history/energy/".format(client.base_url, uuid=uuid)
...
def sync_detailed(
    ...
    *,
    ...
    """Fetch consumed energy history

    Args:
        uuid (str):
        cumulative (Union[Unset, None, bool]):
        end (Union[Unset, None, datetime.datetime]):
        format_ (Union[Unset, None, ApiV2PlantConsumptionHistoryEnergyRetrieveResponseFormat]):
            Default: ApiV2PlantConsumptionHistoryEnergyRetrieveResponseFormat.JSON.
        period (Union[Unset, None, ApiV2PlantConsumptionHistoryEnergyRetrievePeriod]):  Default:
            ApiV2PlantConsumptionHistoryEnergyRetrievePeriod.VALUE_0.
